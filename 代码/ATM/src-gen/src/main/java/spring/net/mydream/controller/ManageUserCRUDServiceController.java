...
public class ManageUserCRUDServiceController {
	...
	public String createUser(CreateUserMessage createUserMsg) {
		...
		try {
			object.put("data", manageUserCRUDService.createUser(createUserMsg.userid,createUserMsg.name,createUserMsg.address));
	...
	public String modifyUser(ModifyUserMessage modifyUserMsg) {
		...
		JSONObject object = new JSONObject();
		try {
			object.put("data", manageUserCRUDService.modifyUser(modifyUserMsg.userid,modifyUserMsg.name,modifyUserMsg.address));
			object.put("msg", "success");
			object.put("code", "200");
		} catch (Exception e) {
			if (e instanceof PreconditionException) {
